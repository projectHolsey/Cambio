...
def choice():
    ...
    while not any(str(x) == y for y in accepted_vals):
        print("Unaccepted entry, please enter another option : " + str(accepted_vals))
        x = input("Enter choice >")
    return x
...
def print_cards(game_player, game_dealer):
